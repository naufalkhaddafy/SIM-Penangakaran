                                                ...
                                                <form action="{{ route('penangkaran') }}" method="post">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" id="kode_penangkara" name="kode_penangkaran"
                                                            ...
                                                            placeholder="Kode Penangkaran"
                                                            value="{{ old('kode_penangkaran') }}">
                            ...
                            <div class="card" style="width: 20rem;">
                                ...
                                <div class="row">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">{{ $data->kode_penangkaran }}</p>
                                        <p class="card-text">{{ $data->lokasi_penangkaran }}</p>
                                        <a href="/penangkaran/{{ $data->kode_penangkaran }}"
                                            class="btn btn-primary">Detail Penangkaran</a>
                                    </div>
                                </div>
                            </div>
                        </div>
